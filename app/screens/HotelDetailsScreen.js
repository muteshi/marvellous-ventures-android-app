...
function HotelDetailsScreen({ route, navigation }) {
  ...
  const adults = route.params.hotel_lowest_price[1];
  const adultsNum = adults > 1 ? "adults" : "adult";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.priceContainer}>
          <ListItem
            prefix={"from"}
            title={`KES ${route.params.hotel_lowest_price[0]}`}
            subTitle={`Price for 1 night, ${adults} ${adultsNum}`}
