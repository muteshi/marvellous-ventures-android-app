...
function ConferenceHotelDetails({ route, navigation }) {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.priceContainer}>
          <ListItem
            prefix={"from"}
            title={`KES ${route.params.conference_lowest_price[0]}`}
            subTitle={`Price for 1 guest per day`}
            onPress={() => navigation.navigate(routes.CONFERENCE_ROOMS, hotel)}
          />
        </View>
...
export default ConferenceHotelDetails;
